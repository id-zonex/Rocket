...
public class SurvivalControler : MonoBehaviour
{
    ...
    [Header("шанс переходу гри на верикальний режим")]
    [SerializeField] [Range(0, 100)] 
    int chanceSpawnVertIcalCrossing;

    [Header("шанс переходу гри на горизонтальний режим")]
    [SerializeField] [Range(0, 100)] 
    int chanceSpawnHorizontalCrossing;
